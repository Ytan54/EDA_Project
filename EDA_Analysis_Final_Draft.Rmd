...
#### 1) Introducing the Dataset
  ...
  For this project, we work with data from the **2015 Behavioral Risk Factor Surveillance System (BRFSS)**—a nationwide health survey run each year by the **Centers for Disease Control and Prevention (CDC)** in partnership with U.S. states and territories. The survey is conducted through telephone interviews, both landline and cellular, reaching adults aged 18 and older living in community settings.  

  The BRFSS was designed to track health-related risk behaviors, chronic conditions, and use of preventive care across the U.S. In 2015, it spanned all 50 states, the District of Columbia, Puerto Rico, and Guam, giving us a rich, representative snapshot of health behaviors nationwide. The dataset is weighted so its findings reflect state-level populations—making it a trusted source for public health planning, policy-making, and resource allocation.  
  
  We chose the **2015 BRFSS** dataset for both practical and methodological reasons that matter for our exploration. More recent datasets have **gaps in state coverage**—for example, the 2023 survey omits large states such as Pennsylvania and Kentucky—which could make national estimates less reliable. On top of that, starting in 2016, the BRFSS structure changed to comply with **federal executive orders**, altering how variables such as race, ethnicity, and health equity are recorded. While these changes were meant to improve transparency, they also created inconsistencies that make it harder to compare across years.  

  The 2015 dataset avoids these problems. Its structure is stable, widely used in research, and allows us to establish a **clean baseline** for potential comparison with newer datasets, including the upcoming 2025 BRFSS. Working with this version means we can focus on meaningful patterns in the data without worrying about major shifts in survey design. 
<br><br>

#### 2) Research Interest

  Within this dataset, our main outcome of interest is **heart attack history** (`CVDINFR4`). This choice is deliberate: heart attacks are urgent, life-threatening events that demand immediate medical attention ([NIH](https://www.nhlbi.nih.gov/health/heart-attack)), and they can occur even without a prior coronary heart disease diagnosis ([Cleveland Clinic](https://my.clevelandclinic.org/health/diseases/16818-heart-attack-myocardial-infarction)). The 2015 BRFSS contains enough reported cases to give our analysis strong statistical power, and the outcome’s public health weight is significant—about one in five cardiovascular deaths in the U.S. are due to heart attacks ([CDC, 2023](https://www.cdc.gov/heartdisease/facts.htm)).  
  
  As we move through this analysis, we aim not only to uncover statistical patterns but also to interpret them responsibly, especially when discussing groups that may be more vulnerable or underrepresented. 

  By focusing on this outcome, our journey through the data will center on how demographic, behavioral, and health history factors connect to heart attack risk. With that in mind, let’s look at the specific variables that will guide our exploration.  
<br><br>

#### 3) Description of Selected Variables

  After reviewing established research on cardiovascular disease risk factors, we selected variables that capture demographic, health, and behavioral characteristics relevant to understanding heart attack risk:  
...
- **X_BMI5CAT**: BMI category based on X_BMI5.  
  ...
  Taken together, these variables give us a balanced mix of demographic indicators, medical history, and lifestyle behaviors. They set the stage for uncovering how different aspects of a person’s life may interact when it comes to heart attack risk. The next step in our exploration will be preparing and transforming the data so we can uncover these relationships in a clear, systematic way.
<br><br>
